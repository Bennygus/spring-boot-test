...
import com.example.spring.boot.test.service.DepartmentService;
import com.example.spring.boot.test.service.DepartmentServiceImp;
...
public class DepartmentController {
    ...
    LOGGER.info("Inside savedDepartment of DepartmentController");
